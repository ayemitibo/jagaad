<template>
  <nav class="pagination">
    <ul class="pagination__list">
      <li class="pagination__item" @click="movePrev">
      ...
      <slot :current-item="currentStep" />
      <li class="pagination__item" @click="moveNext">
        <a href="#" class="pagination__link">
          <svg
            class="icon"
            width="8px"
  ...
  methods: {
    ...
    moveNext(event) {
      ...
      if (this.currentStep >= this.end) {
        ...
        this.currentStep = this.currentStep + 1;
        this.$emit("get-products", { limit: 6, offset: this.currentStep });
      }
    },
    movePrev(event) {
      event.preventDefault();
